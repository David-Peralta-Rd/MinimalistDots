...
kb:exec("V", vars.cliphist,   "Abrir lista de portapapeles")
...
kb:exec("SHIFT+ALT+BACKSPACE", "reboot", "Reiniciar PC")

-- Wallpaper select
kb:exec("SHIFT+T", HOME .. "/.config/hypr/hyprland/scripts/select_wallpaper.sh", "Elegir fondo de pantalla")

-- Keybinds Show
kb:exec("SHIFT+ALT+K", HOME .. "/.local/bin/show_binds", "Mostrar atajos de teclado")

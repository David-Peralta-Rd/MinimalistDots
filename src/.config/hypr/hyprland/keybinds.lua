...
kb:category("Aplicaciones")
  ...
  :exec("F", vars.terminal_float, "Abrir terminal flotante / Open floating terminal")
...
kb:category("Sistema")
  ...
  :exec("SHIFT+BACKSPACE", "sync && systemctl poweroff", "Apagar PC / Shut down PC")
  :exec("SHIFT+ALT+BACKSPACE", "sync && systemctl reboot", "Reiniciar PC / Reboot PC")
